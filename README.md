...
Fork of [PDF++](https://github.com/RyotaUshio/obsidian-pdf-plus) with an Annotator-style annotation sidebar, per-PDF annotation notes, and one-click "Annotate selection". Install via BRAT: `prdai-archive/obsidian-scholar-pdf`.
