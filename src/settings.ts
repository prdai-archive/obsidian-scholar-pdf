...
export interface PDFPlusSettings {
	...
	scholarOpenSidebarOnAnnotate: boolean;
	scholarAskForComment: boolean;
}

export const DEFAULT_SETTINGS: PDFPlusSettings = {
	scholarAnnotationFolder: 'annotations',
	scholarOpenSidebarOnAnnotate: true,
	scholarAskForComment: true,
	displayTextFormats: [
		// {
	...
	defaultSidebarView: SidebarView.OUTLINE,
	outlineDrag: true,
